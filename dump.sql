...
INSERT INTO `alerta` VALUES (1,2,1,2);
...
INSERT INTO `avaliacao` VALUES (1,1,2,1),(2,2,2,2);
...
INSERT INTO `brand` VALUES (1,'Coca Cola Company',NULL);
...
INSERT INTO `categoria` VALUES (1,'Alimento',NULL),(2,'Saladas',1),(3,'Bebidas',1),(4,'Verduras',2),(5,'Refrigerantes',3);
...
INSERT INTO `cidade` VALUES (1,1,'Santa Maria'),(2,1,'Cruz Alta'),(3,1,'Rosário do Sul'),(4,2,'Balneário Arroio do Silva '),(5,2,'Araranguá'),(6,2,'Criciuma');
...
INSERT INTO `estabelecimento` VALUES (1,'Carrefour',NULL,'Rio Branco','732',NULL,NULL,NULL,1,2,1);
...
INSERT INTO `preco` VALUES (1,4.00,2,2,1,1,'2017-07-07 16:51:50'),(2,4.70,2,2,1,1,'2017-07-07 16:51:50'),(3,3.70,2,2,1,1,'2017-07-07 16:52:14');
...
INSERT INTO `produto` VALUES (1,'coca cola',24,1,5,1),(2,'alface',NULL,NULL,4,NULL);
...
INSERT INTO `tipo_avaliacao` VALUES (1,'OK',1),(2,'NOT',-1),(3,'HOAX',-10),(4,'OLD',-1),(5,'UNK',0),(6,'SUPER',2);
...
INSERT INTO `tipo_estabelecimento` VALUES (1,'Supermercado',NULL),(2,'Farmácia',NULL);
...
INSERT INTO `tipo_logradouro` VALUES (1,'R','Rua'),(2,'Av','Avenida'),(3,'Al','Alameda');
...
INSERT INTO `tipo_preco` VALUES (2,'Normal'),(3,'Promo semanal'),(4,'Promo mensal'),(5,'Promo única');
...
INSERT INTO `tipo_usuario` VALUES (3,'adm'),(2,'estabelecimento'),(1,'usuario');
...
INSERT INTO `uf` VALUES (1,'RS','Rio Grande do Sul'),(2,'SC','Santa Catarina');
...
INSERT INTO `usuario` VALUES (2,'brlaranjeira','Bruno','Rezende Laranjeira',30000,'6e8f107c4ea202ee0dd7ebb5d1c802585ec111f843d8b8b6aeaa5affa3c9741c','\0#¶3çe|X¦ÑF£¢|ìãÙVüjs ¬Õ\Z+',3);
...
-- Dump completed on 2017-07-07 19:08:42
